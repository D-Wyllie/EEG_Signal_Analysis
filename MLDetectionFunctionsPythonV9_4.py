...
def AnalyseSignals(StartVals,EndVals,signal,signalCURVES,signalcurveave):
    ...
    column_names_main = ['SignalNumber','Startsig','Endsig''SignalLength','NoPeaks','NoDips','NoPeaksBeforeGlobal','NoPeaksAfterGlobal','NoDipsBeforeGlobal','NoDipsAfterGlobal','DipDepth','MedianPeakDifference']
...
def AnalyseSignalsFailsafeVer(StartVals,EndVals,signal,signalres2,signalCURVES,DFnorm,signalcurveave,gap):
    ...
    column_names_main = ['SignalNumber','Startsig','Endsig','SignalLength','NoPeaks','NoDips','NoPeaksBeforeGlobal','NoPeaksAfterGlobal','NoDipsBeforeGlobal','NoDipsAfterGlobal','DipDepth','MedianPeakDifference','Start','End']
    MainSignalDF = pd.DataFrame(columns = column_names_main, dtype=object)
